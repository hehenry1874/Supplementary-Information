/**
 * Port physical expansion proxy — Google Earth Engine FULL SAFE VERSION
 *
...
// Include 2026 as partial-calendar-year rows (satellite_year_type = partial_year).
// If false, YEARS drops 2026 and EXPORT_YEAR_TAG becomes no2026.
var INCLUDE_2026_PARTIAL = true;

var YEARS = INCLUDE_2026_PARTIAL
  ? [2015, 2018, 2021, 2024, 2026]
  : [2015, 2018, 2021, 2024];

var BUFFER_KM_LIST = [5, 10];
var MAX_BUFFER_KM = 10;

var USE_UPLOADED_ASSET = true;
var PORTS_ASSET_ID = 'projects/my-project-1/assets/ports_wpi_full_368_ee_table';

// Batch: (0,50) (50,50) … (300,50); last (350,18) for 368 ports.
var BATCH_START = 0;
var BATCH_SIZE = 50;
var EXPORT_SUFFIX = 'batch000_050';
...
Export.table.toDrive({
  collection: panelFc,
  description: 'port_satellite_scale_panel_' + EXPORT_SUFFIX + '_' + EXPORT_YEAR_TAG,
  folder: 'gee_exports',
  fileFormat: 'CSV'
});
